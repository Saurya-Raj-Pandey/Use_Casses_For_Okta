    ...
    <>
      <div className="Text">
        <ul>
          <li>
            {" "}
            Create a function called <b>ActivateUserWithRecoveryquestion</b>
          </li>
          <li>
        ...
        <p>
          {" "}
          <img
            src="/Use_cases/Activating_User_With_Recovery_Question/Activating_User_with_Recovery_Question_Code.png"
            alt="hwllo"
          />
        </p>
        <h5>
          {" "}
          <b>Fig:Activating User with Recovery Question</b> <br></br>
        </h5>
        <p>
          {" "}
        ...
        <ul>
          ...
          <li>
            ...
            withRecoveryQuestion here is the
            ...
            Creation with it's Recovery Question with these requirements{" "}
            <b>
              {" "}
          ...
          <li>
            ...
            created and it is in <b>Active</b> Sucessfully
          </li>
        </ul>
        <p>
          {" "}
