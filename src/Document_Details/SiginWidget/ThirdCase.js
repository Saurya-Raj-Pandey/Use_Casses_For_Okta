    ...
    <>
      <div className="Text">
        <ul>
          <li>
            {" "}
            Create a function called <b>UserWithoutCredentials</b>
          </li>
          <li>
        ...
        <p>
          {" "}
          <img
            src="../Use_cases/User_Without_Credentials/User_Without_Credentials_Code.png"
            alt="hwllo"
          />
        </p>
        <h5>
          {" "}
          <b>Fig:Create User Without Credentials</b> <br></br>
        </h5>
        <p>
          {" "}
          <img
        ...
        <ul>
          ...
          <li>
            ...
            "/users?activate=false".The withoutCredentials here is the
            ...
            Creation with it's User Without Credentials with these requirements
          </li>
          <li>
