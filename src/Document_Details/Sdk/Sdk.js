  ...
  return (
    <>
      <div className="Text">
        ...
        <p>
          <h4>
            Here Inside the <b>sdk</b> file we have <b>route</b> and{" "}
        ...
        <ul>
          ...
          <li>
            Here we have imported the <b>okta node package</b> which helps to
            route to Use cases
          </li>
          <li>
            Here we have the <b>const oktaClient </b> and inside it we have
            declared the{" "}
            <b>(orgUrl,token)from the .env file which has value of it.</b>
          </li>
          <li>
            The value of the{" "}
